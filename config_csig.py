...
def argument_parser():
    ...
    parser.add_argument("--dataset", type=str, default="CSIG")
    parser.add_argument("--num-att", type=int,default=86)
    parser.add_argument("--debug", action='store_false')

    parser.add_argument("--batchsize","-b", type=int, default=128)
    parser.add_argument("--train-epoch", type=int, default=25) #111
    parser.add_argument("--height", type=int, default=224)
    parser.add_argument("--width", type=int, default=224)
    parser.add_argument("--lr-ft", type=float, default=0.01, help='learning rate of feature extractor')
    parser.add_argument("--lr-new", type=float, default=0.1, help='learning rate of classifier_base') #111
    ...
    # parser.add_argument('--', default='cuda:0')
    return parser
