...
def argument_parser():
    ...
    parser.add_argument("--dataset", type=str, default="UAVHUMAN")
    parser.add_argument("--num-att", type=int,default=47)
    parser.add_argument("--debug", action='store_false')

    parser.add_argument("--batchsize","-b", type=int, default=16)
    parser.add_argument("--train-epoch", type=int, default=20)
    ...
    parser.add_argument('--seed',default=213205, type=int)
    ...
    parser.add_argument('--dim-forward', default=768, type=int)
    # parser.add_argument('--hidden-dim', default=1024, type=int)
    # parser.add_argument('--dim-forward', default=1024, type=int)
    parser.add_argument('--decN', default=2, type=int)
    parser.add_argument('--decNL', default=2, type=int)
    parser.add_argument('--dropout', default=0.1, type=float,help="Dropout applied in the transformer")
    parser.add_argument('--nheads', default=4, type=int)

    # parser.add_argument('--lam', default=0.3, type=float,help="csra arguement")
    return parser
