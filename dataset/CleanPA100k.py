...
class AttrDataset(Dataset):
    ...
    def __init__(self, split, transform=None, target_transform=None, testing=None,known_labels=None):
        ...
        #     f'dataset name {args.dataset} is not exist'
            ...
            data_path = '/workspace/Label2Label-main/Pedestrian_Attribute/dataset/preprocess/data/PA100k/dataset.pkl'
            # breakpoint()
            ...
            self.root_path = '/workspace/Label2Label-main/Pedestrian_Attribute/dataset/preprocess/data/PA100k/data'
